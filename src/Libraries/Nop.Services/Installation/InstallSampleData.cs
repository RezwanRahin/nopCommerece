...
public partial class InstallationService
{
    ...
    protected virtual async Task InstallNewsAsync()
    {
        var news = new List<NewsItem>
        {
            new()
            {
                ...
                LanguageId = await GetDefaultLanguageIdAsync(),
                Title = "About AHAL",
                Short = "It's stable and highly usable. From downloads to documentation, www.ahalllc.com offers a comprehensive base of information, resources, and support to the AHAL community.",
                Full = "<p>For full feature list go to <a href=\"https://www.ahalllc.com\">AHAL.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                Published = true,
                CreatedOnUtc = DateTime.UtcNow
            },
            new()
    ...
    protected virtual async Task InstallOrdersAsync()
    {
        ...
        await _dataProvider.InsertEntityAsync(new GiftCard
        {
            ...
            RecipientEmail = "brenda_lindgren@aAHAL.com",
