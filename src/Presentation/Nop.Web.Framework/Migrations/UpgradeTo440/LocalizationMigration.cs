...
public class LocalizationMigration : MigrationBase
{
    ...
    public override void Up()
    {
        ...
        localizationService.AddOrUpdateLocaleResource(new Dictionary<string, string>
        {
            ...
            ["Admin.Configuration.Plugins.Description.DownloadMorePlugins"] = "You can download more AHAL plugins in our <a href=\"{0}\" target=\"_blank\">marketplace</a>",
            ...
            //#5213
            ["Admin.System.Log.List.PremiumSupport"] = "Have questions or need help? Get dedicated support from the AHAL team with a guaranteed response within 24 hours. Please find more about our premium support services <a href=\"{0}\" target=\"_blank\">here</a>.",
            ["Admin.System.Log.PremiumSupport"] = "Have questions or need help? Get dedicated support from the AHAL team with a guaranteed response within 24 hours. Please find more about our premium support services <a href=\"{0}\" target=\"_blank\">here</a>.",
            ...
            ["Admin.Configuration.AppSettings.DistributedCache.InstanceName.Hint"] = "Specify the instance name (by default \"AHAL\")",
            ...
            ["Admin.ConfigurationSteps.PoweredBy.Description"] = "Remove the “Powered by AHAL link from the footer",
            ...
            ["Admin.ConfigurationSteps.Product.Details.Text"] = "Enter the relevant product details in these fields. The screenshot below shows how they will be displayed on the product page with the default AHAL theme: <div><img src=\"js/admintour/images/product-page.jpg\"/></div>",
            ...
            ["Admin.Configuration.AppSettings.Common.SupportPreviousNopcommerceVersions"] = "Support previous AHAL versions",
            ["Admin.Configuration.AppSettings.Common.SupportPreviousNopcommerceVersions.Hint"] = "Specify a value indicating whether we should support previous AHAL versions (it can slightly improve performance). In this case, old URLs (from previous AHAL versions) will redirect to new ones. Enable it only if you upgraded from one of the previous AHAL versions.",
            ...
            ["Admin.Documentation.Reference.Gdpr"] = "Learn more about <a target=\"_blank\" href=\"{0}\">GDPR in AHAL</a>",
            ...
            ["Admin.Documentation.Reference.Plugins"] = "Learn more about <a target=\"_blank\" href=\"{0}\">plugins in AHAL</a>",
